...
console.log(document.body.querySelectorAll(".merveilles"));
...
console.log(document.body.querySelector("#nouvelles"));
...
console.log(document.body.querySelector("#antiques").getElementsByClassName("existe"));

// Affiche l'enfant de l'élément d'id "antiques" ayant la classe "existe"

console.log(document.body.querySelector("#antiques").children);
...
console.log(document.body.querySelectorAll("p")[0]);

// Nombre de paragraphes à l'intérieur de l'élément d'id "contenu"

console.log(document.body.querySelector("#contenu").querySelectorAll("p").length);

// Le 2e paragraphe à l'intérieur de l'élément d'id "contenu"

console.log(document.body.querySelector("#contenu").querySelectorAll("p")[1]);

// Nombre d'éléments ayant la classe "existe"

console.log(document.body.querySelectorAll(".existe").length);

// Tous les éléments ayant la classe "existe"

console.log(document.body.querySelectorAll(".existe"));

// Nombre d'enfants de l'élément d'id "antiques" ayant la classe "existe"

console.log(document.body.querySelector("#antiques").querySelectorAll(".existe").length);
...
console.log(document.body.querySelector("#antiques").querySelector(".existe"));
...
console.log(document.body.querySelector("#contenu").innerHTML);

// Le contenu HTML de l'ul qui n'a pas la classe "merveilles"

console.log(document.body.querySelector("ul:not(.merveilles)").innerHTML);
...
console.log(document.body.querySelector("#contenu").textContent);

// Le contenu textuel de l'élément identifié par "contenu"

console.log(document.body.querySelector("#contenu").querySelector("ul:not(.merveilles)").children[0].textContent);
...
console.log(document.body.querySelector("#contenu").querySelector("ul:not(.merveilles)").children[0].firstChild.getAttribute("href"));

// Affiche l'identifiant de la première liste

console.log(document.body.querySelector("#antiques").getAttribute("id"));
console.log(document.body.querySelector("#antiques").hasAttribute("id"));

// Affiche l'attribut href du premier lien

console.log(document.body.querySelector("#contenu").querySelector("ul:not(.merveilles)").children[0].firstChild.hasAttribute("href"));

// Vérifie la présence de l'attribut target sur le premier lien

console.log(document.body.querySelector("#contenu").querySelector("ul:not(.merveilles)").children[0].firstChild.hasAttribute("target"));
...
console.log(document.body.querySelector("#antiques").classList);

// Affiche le nombre de classes que possède l'élément d'id "antiques"

console.log(document.body.querySelector("#antiques").classList.length);

// Affiche la première classe que possède l'élément d'id "antiques"

console.log(document.body.querySelector("#antiques").classList[0]);

// Teste si l'élément d'id "antiques" possède la classe "merveille"

console.log(document.body.querySelector("#antiques").classList.contains("merveilles"));